...
# This Fork is introduce the following Features for the origin archived repository :

1. Using image docker from [anasoid/jmeter](https://hub.docker.com/r/anasoid/jmeter)
2. Advaced feature are avilable from the image [anasoid/jmeter](https://hub.docker.com/r/anasoid/jmeter)
3. Advaced feature are avilable from the image .
4. Easy way to install plugins, see <https://github.com/anasoid/docker-jmeter#plugins-installation> the easiest way is <https://github.com/anasoid/docker-jmeter#download-dependencies-automatically-with-plugin-manager>
5. Last version of Jmeter 5.4.x
6. Last version of Terraform.
7. Use arguments as parameters than environement variables.
8. Add Jmeter logs to artifact from all workers.
9. Add timeout to stop container if there is any problem container will be stopped after timeout.
10. Possibility to split CSV.
